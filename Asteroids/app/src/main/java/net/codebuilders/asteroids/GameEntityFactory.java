...
public class GameEntityFactory implements EntityFactory {
    ...
    public Entity newAsteroid(SpawnData data) {
        var hp = new HealthIntComponent(4); // was 2

        var hpView = new ProgressBar(false);
        hpView.setFill(Color.LIGHTGREEN);
        hpView.setMaxValue(4);
        hpView.setWidth(85);
        hpView.setTranslateY(38); // was 90 - puts the health bar in the center of the asteroid instead of the bottom
    ...
    class SuperSlowTimeEffect extends Effect {
        ...
        public SuperSlowTimeEffect() {
            super(Duration.seconds(0.1)); // was 0.5 - shots were too slow
        }

        @Override
        public void onStart(Entity entity) {
            entity.getComponent(TimeComponent.class).setValue(0.05); // was 0.05
        }

        @Override
        public void onEnd(Entity entity) {
            entity.getComponent(TimeComponent.class).setValue(3.0); // was 3.0
        }
    }
